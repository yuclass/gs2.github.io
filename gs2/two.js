...
lib.ssMetadata = [
		{name:"two_atlas_1", frames: [[0,0,1200,675],[1202,0,400,399]]}
];
...
(lib.Behind = function() {
	this.initialize(ss["two_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#663300").s().p("EhK/A6+MAAAh17MCV/AAAMAAAB17g");
...
}).prototype = getMCSymbolPrototype(lib.Cursor_1, new cjs.Rectangle(-88,-86,171.9,185.2), null);
...
}).prototype = getMCSymbolPrototype(lib.Behind_1, new cjs.Rectangle(-93,0,1152,705.5), null);
...
}).prototype = getMCSymbolPrototype(lib._2, new cjs.Rectangle(-160,-142,171.9,185.2), null);
...
}).prototype = getMCSymbolPrototype(lib._1, new cjs.Rectangle(-1.7,-11.9,1127,543.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_5.cache(-4,-14,1131,548);
...
p.nominalBounds = new cjs.Rectangle(478.5,257.7,481.5,489.90000000000003);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/two_atlas_1.png?1659292029578", id:"two_atlas_1"}
	],
	preloads: []
};
